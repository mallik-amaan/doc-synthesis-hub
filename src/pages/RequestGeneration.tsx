                ...
                <div className="border-t border-border pt-6 mt-6">
                  ...
                  {advancedData.enable_handwriting && (
                    <div className="space-y-5 pl-1">
                      ...
                      {/* Ink Filter + Enhancements toggles */}
                      ...
                      <div className="space-y-2">
                        <div>
                          ...
                          <p className="text-[11px] text-muted-foreground mt-0.5">
                            Select handwriting personalities to use. Each author in the document is assigned one style at random.
                            {advancedData.handwriting_writer_ids.length === 0 && ' Leaving all unselected uses all 7 styles.'}
                          </p>
                        </div>
