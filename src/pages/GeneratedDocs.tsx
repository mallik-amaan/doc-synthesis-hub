...
import { Download, FileText, Calendar, Clock, History, MoreVertical, Eye, Trash2, Loader2 } from 'lucide-react';
            ...
            <div key={generation.id} className="doc-card">
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-foreground">{generation.metadata?.documentName ?? 'Untitled'}</h3>
              ...
              <div className="flex items-center gap-3 mb-3 text-xs text-muted-foreground">
                ...
                <span className="flex items-center gap-1 text-xs text-muted-foreground">
                  ...
                  {timeAgo(generation.updated_at || generation.created_at)}
                </span>
              </div>
